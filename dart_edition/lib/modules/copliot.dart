        ...
        child: Column(
          ...
          children: [
            ...
            const Align(
              ...
              child: LargeTitle(icon: Icons.library_books_outlined, text: "Copliot"),
            ),
            ...
            Card(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    const MediumTitle(icon: Icons.folder, text: "模型選擇"),
                  ],
                ),
              ),
            ),
            Card(
              ...
              child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const MediumTitle(icon: Icons.format_list_bulleted, text: "對話紀錄"),
                  ],
                ),
              ),
            ),
            Card(
              ...
              child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const MediumTitle(icon: Icons.library_books, text: "對話框預留位置"),
                    const MediumTitle(icon: Icons.library_books, text: "模式選擇"),
                  ],
                ),
              ),
            ),
